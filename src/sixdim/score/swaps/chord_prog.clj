...
;; tmp
;; lcd1: long-chord-1 first note of :downbeats ordered in long form chord
;; 4nd1: next :downbeat from previous note on quarter-notes vector
;; 4nd2: next-next :downbeat from previous note on quarter-notes vector
;; 8nd1: next :downbeat from previous note on eights-notes vector
;; 0: set note to init note and play:false
(def fbar_test_pattern_1
  "full bar (fbar) test pattern"
  {"quarter" ["lcd1" "4nd1" "4nd1" "4nd1"]
   "eight"   [0 0 0 0]
